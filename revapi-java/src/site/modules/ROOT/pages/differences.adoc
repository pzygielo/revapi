...
[[java.method.visibilityIncreasedInFinalClass]]
=== Method Visibility Increased In Final Class - `java.method.visibilityIncreasedInFinalClass`
[cols="35s,<65d"]
|=============
| Binary severity   | equivalent
| Source severity   | non-breaking
...
Increasing visilibility of a method in a final class doesn't represent neither source nor binary incompatibility.
...
=== Method Visibility Reduced - `java.method.visibilityReduced`
[cols="35s,<65d"]
|=============
| Binary severity   | breaking
| Source severity   | breaking
